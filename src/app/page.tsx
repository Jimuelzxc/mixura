            ...
            <div className={cn(isCanvasFullscreen && "hidden")}>
              {isAllBoardsView ? (
                  <div className="mb-8 py-10">
                      <h1 className="text-[10rem] font-bold tracking-tighter leading-none">All Boards</h1>
                  </div>
              ) : activeBoard && (
                  <div className="mb-8 group py-10">
                      <div className="flex items-center gap-4">
                          <h1 className="text-[10rem] font-bold tracking-tighter leading-none">{activeBoard.name}</h1>
                          <TooltipProvider>
                            <Tooltip>
